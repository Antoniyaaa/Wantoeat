    ...
    internal class IngredientsSeeder : ISeeder
    {
        public async Task SeedAsync(ApplicationDbContext dbContext, IServiceProvider serviceProvider)
        {
            ...
            IEnumerable<Ingredient> entities = new List<Ingredient>
            {
                ...
                "vitamins C and B6. Source: www.healthline.com", ImagePath = "/images/Potatoes_39548734.jpg"},
                // Allergen Nr. 7
                ...
                "Source: www.nutritionadvance.com", ImagePath = "/images/Mozzarella_2776500.jpg" }
            };
